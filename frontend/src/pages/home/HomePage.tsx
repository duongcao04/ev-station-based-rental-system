              ...
              <div className='bg-white rounded-2xl shadow-2xl p-8'>
                ...
                <div className='space-y-4'>
                  {vehicles.slice(0, 2).map((vehicle) => (
                    <div
                      key={vehicle.id}
                      className='flex items-center space-x-4 p-4 border border-gray-200 rounded-lg hover:border-green-300 transition-colors'
                    >
                      <img
                        src={vehicle.image}
                        alt={vehicle.name}
        ...
        <div className='max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Từ sedan sang trọng đến SUV rộng rãi, chúng tôi có đủ loại xe cho
              mọi nhu cầu
            </p>
          </div>
      ...
      <section className='py-20 bg-green-600'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-green-100 mb-8 max-w-2xl mx-auto'>
            Tham gia cùng hàng nghìn khách hàng đã tin tưởng lựa chọn dịch vụ
            thuê xe điện của chúng tôi
          </p>
